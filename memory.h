...
#define FLASH_BOOT_START	(FLASH_ORIGIN)  //0x08000000
#define FLASH_BOOT_LEN		(0x8000)        

#define FLASH_META_START	(FLASH_BOOT_START + FLASH_BOOT_LEN) //0x08008000
#define FLASH_META_LEN		(0x8000)

#define FLASH_APP_START		(FLASH_META_START + FLASH_META_LEN)  //0x08010000

#define FLASH_META_MAGIC	(FLASH_META_START)   //0x08008000
