...
const pb_field_t AccountLabelsType_fields[3] = {
    PB_FIELD2(  1, UINT32  , REQUIRED, STATIC  , FIRST, AccountLabelsType, count, count, 0),
    PB_FIELD2(  2, MESSAGE , REPEATED, STATIC  , OTHER, AccountLabelsType, labels, count, &AccountLabelType_fields),
    PB_LAST_FIELD
};

const pb_field_t AccountLabelType_fields[3] = {
    PB_FIELD2(  1, UINT32  , REQUIRED, STATIC  , FIRST, AccountLabelType, index, index, 0),
    PB_FIELD2(  2, STRING  , REQUIRED, STATIC  , OTHER, AccountLabelType, label, index, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
STATIC_ASSERT((pb_membersize(HDNodePathType, node) < 65536 && pb_membersize(MultisigRedeemScriptType, pubkeys[0]) < 65536 && pb_membersize(TxInputType, multisig) < 65536 && pb_membersize(TxOutputType, multisig) < 65536 && pb_membersize(TransactionType, inputs[0]) < 65536 && pb_membersize(TransactionType, bin_outputs[0]) < 65536 && pb_membersize(TransactionType, outputs[0]) < 65536 && pb_membersize(AccountLabelsType, labels[0]) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_HDNodeType_HDNodePathType_CoinType_MultisigRedeemScriptType_TxInputType_TxOutputType_TxOutputBinType_TransactionType_TxRequestDetailsType_TxRequestSerializedType_IdentityType_AccountLabelsType_AccountLabelType)
#endif
