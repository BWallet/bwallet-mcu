	...
	if (fails) {
		if (fails > 2) {
			switch (storage_getLang()) {
				case CHINESE :
					layoutZhDialogSwipe(DIALOG_ICON_INFO, NULL, NULL, NULL, "输入#P##I##N#码错误", NULL, "请稍等#.##.##.#", NULL);
					break;
				default	:
...
bool protectPassphrase(void)
{
	...
	switch (storage_getLang()) {
		case CHINESE :
			layoutZhDialogSwipe(DIALOG_ICON_INFO, NULL, NULL, NULL, "请在电脑键盘上输入", NULL, "您的密码#.#", NULL);
			break;
		default	:
